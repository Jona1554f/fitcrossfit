...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-04-2021 a las 20:57:24
...
('1529336794', 'Conocoto', 'San miguel ', 'quito', '080004'),
('1580392920', 'Calle 92 Carrera 7', 'conocoto', 'machala', '110431'),
('1580393244', 'Calle 12 N 34-23', 'cocnocoto', 'quito', '110611'),
('1617744027', 'conocoto', 'San miguel ', 'quito', '23135'),
('1617745827', 'Sangolqui', 'Jose Urvina', 'Quito', '15487'),
('1619649683', 'Floresta', 'San Martin de j', 'Quito', '15587');
...
('jonathan', '1234', '123456', 'Configuro Web');
...
(5, 'CXYFBV', '1617744027', '2021-04-06', '2021-08-06', 'yes'),
(6, 'CXYFBV', '1617745827', '2021-04-06', '2021-08-06', 'no'),
(7, 'POQKJC', '1617745827', '2021-04-09', '2021-05-09', 'yes'),
(8, 'POQKJC', '1619649683', '2021-04-28', '2021-06-28', 'no'),
(9, 'CXYFBV', '1619649683', '2021-04-28', '2021-08-28', 'yes'),
(10, 'CXYFBV', '1529336794', '2021-04-28', '2021-08-28', 'yes');
...
(1, '8500', '1.80', '95', '26', 'falta muscular', '1529336794'),
(2, '8500', '1.80', '95', '26', '', '1580392920'),
(3, '', '', '', '', '', '1580393244'),
(4, NULL, NULL, NULL, NULL, NULL, '1617744027'),
(5, '58', '1.78', '75lb', '45%', 'falta de masa muscular', '1617745827'),
(6, '58%', '1.75', '45lb', '15%', 'falta cardio', '1619649683');
...
('CXYFBV', 'Funcional Trap', 'Rutinas de cardio que se basan en circuitos prolongados, donde se escala el esfuerzo, en 6 niveles y gradualmente se baja durante el lapso de 1 hora.', '4', 30, 'yes'),
...
('NLFOSQ', 'plan hombros', 'Una rutina de ejercicios directa para ganancia de grasa muscular', '3', 60, 'yes'),
('POQKJC', 'Plan piernas', 'Una suscripción mensual que desbloquea toda la aplicación ConfiguroWeb Crossfit y el soporte del entrenador en el chat.', '2', 58, 'yes'),
('VEIPGA', 'Rutina principiante', 'Este plan en aceptable para las personas primerizas en el ámbito crossfit ', '3', 25, 'no');
...
('1617744027', 'jonathan', 'Hombre', '5165165165165', 'jsc.flores@yavirac.e', '1998-04-29', '2021-04-06'),
('1617745827', 'Steven Flores', 'Hombre', '0979288702', 'jonathanf665@hotmail', '1998-02-01', '2021-04-06'),
('1619649683', 'Carlos', 'Hombre', '098754528', 'carlos1558@gmail.com', '2000-02-25', '2021-04-28');
...
--
ALTER TABLE `timetable`
  MODIFY `tid` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
